...
printf $DIVIDER
log_msg "Lyquix LAMP server setup on Ubuntu 20.04"
printf $DIVIDER
...
echo "Installing PHP..."
PCKGS=("mcrypt" "imagemagick" "php7.4" "php7.4-common" "php7.4-gd" "php7.4-imap" "php7.4-mysql" "php7.4-mysqli" "php7.4-cli" "php7.4-cgi" "php7.4-fpm" "php7.4-zip" "php-pear" "php-imagick" "php7.4-curl" "php7.4-mbstring" "php7.4-bcmath" "php7.4-xml" "php7.4-soap" "php7.4-opcache" "php7.4-intl" "php-apcu" "php-mail" "php-mail-mime" "php-all-dev" "php7.4-dev" "libapache2-mod-php7.4" "php7.4-memcached" "php7.4-redis" "composer")
for PCKG in "${PCKGS[@]}"; do
	echo " * Installing $PCKG..."
	apt-get -y -q --no-install-recommends install ${PCKG}
done
...
if [ ! -f /etc/php/7.4/fpm/php.ini.orig ]; then
	echo "Backing up PHP.ini configuration file to /etc/php/7.4/fpm/php.ini.orig"
...
if [ ! -f /etc/php/7.4/fpm/pool.d/www.conf.orig ]; then
	echo "Backing up PHP-FPM Pool configuration file to /etc/php/7.4/fpm/pool.d/www.conf.orig"
...
echo "Please check the log file /srv/www/lamp-ubuntu20.log for important information and any errors."

# Save the log at the end
printf "%s\n" "${LOGMSG[@]}" >>/srv/www/lamp-ubuntu20.log
