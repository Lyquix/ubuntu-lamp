...
printf $DIVIDER
log_msg "Lyquix LAMP server setup on Ubuntu 22.04"
printf $DIVIDER
...
echo "Please check the log file /srv/www/lamp-ubuntu22.log for important information and any errors."

# Save the log at the end
printf "%s\n" "${LOGMSG[@]}" >>/srv/www/lamp-ubuntu22.log
exit
