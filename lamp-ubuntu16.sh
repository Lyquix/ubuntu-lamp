...
perl -pi -e "s/$FIND/$REPLACE/m" /etc/php/7.0/apache2/php.ini
...
perl -pi -e "s/$FIND/$REPLACE/g" /etc/apache2/mods-available/php7.0.conf
...
perl -pi -e "s/$FIND/$REPLACE/m" /etc/mysql/my.cnf
